  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
      <path
        fill="#4E6E81"
        fillOpacity="1"
        d="M0,288L120,250.7C240,213,480,139,720,128C960,117,1200,171,1320,197.3L1440,224L1440,320L1320,320C1200,320,960,320,720,320C480,320,240,320,120,320L0,320Z"
      ></path>
    </svg>
  );
}
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
      <path
        fill="#f1f5f9"
        fillOpacity="1"
        d="M0,224L48,208C96,192,192,160,288,154.7C384,149,480,171,576,192C672,213,768,235,864,256C960,277,1056,299,1152,288C1248,277,1344,235,1392,213.3L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
      ></path>
    </svg>
  );
}
...
export function SvgHome() {
  <span className="absolute bottom-5 left-1/2 -translate-x-1/2 sm:scale-150">
    <svg
      viewBox="0 0 200 200"
      width="350"
      height="350"
    ...
    >
      <path
        fill="#cebea5"
        d="M53.1,-55.7C66.6,-39.5,73.9,-19.8,71.8,-2.1C69.7,15.5,58.1,31.1,44.6,43.4C31.1,55.6,15.5,64.7,-2.7,67.4C-21,70.1,-41.9,66.5,-51.9,54.2C-61.8,41.9,-60.7,21,-60.5,0.2C-60.3,-20.5,-60.9,-41,-50.9,-57.1C-41,-73.3,-20.5,-85.1,-0.4,-84.8C19.8,-84.4,39.5,-71.9,53.1,-55.7Z"
